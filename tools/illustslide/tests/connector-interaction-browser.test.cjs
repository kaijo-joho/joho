...
(async()=>{
  ...
  try{
    ...
    await page.locator('#inspector-toggle').click();await page.locator('[data-inspector-section=view]').click();await page.locator('#view-theme').selectOption('dark');await page.locator('#view-size').selectOption('xlarge');await inspectorSubmit(page);await page.locator('#inspector-close').click();await settle(page);await page.screenshot({path:'/private/tmp/illustslide-elbow-390px.png'});
