...
(async()=>{
  ...
  await page.setViewportSize({width:390,height:850});await page.locator('#view-menu summary').click();await page.locator('#text-size').selectOption('largest');await page.keyboard.press('Escape');
