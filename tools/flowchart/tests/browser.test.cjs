...
async function serve() {
  ...
  const allowed = new Set(['index.html', 'output.js', 'parts.js','layout.js','transitions.js', 'core.js', 'render.js', 'editor.js', 'editor.css', 'storage.js', 'local-autosave.js', 'icon.svg']);
