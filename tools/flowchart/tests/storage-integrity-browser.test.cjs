...
async function serve() {
  ...
  const allowed = new Set(['index.html','output.js','parts.js','layout.js','transitions.js','core.js','render.js','storage.js','local-autosave.js','editor.js','editor.css','icon.svg']);
