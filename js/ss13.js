const slidesData = [
  ...
  {
    "title": "1.1. 合計値を求める関数",
    "note": "&lt;p&gt;<br><span class=\"circLine\"><span class=\"circHead\"><strong>①</strong></span><span class=\"circBody\">【C30】をクリックし「=SUM(」を入力する。&lt;br&gt;</span></span><br><span class=\"circLine\"><span class=\"circHead\"><strong>②</strong></span><span class=\"circBody\">【C7:C29】を選択する。（【C7:C29】が点線で囲まれる）</span></span>&lt;br&gt;<br><span class=\"circLine\"><span class=\"circHead\"><strong>③</strong></span><span class=\"circBody\">「)」を入力する。（関数の入力が終了する）</span></span>&lt;br&gt;<br><span class=\"circLine\"><span class=\"circHead\"><strong>④</strong></span><span class=\"circBody\">⏎リターンキーを押す。（セルの数式の編集が確定し、合計値が表示される）</span></span>&lt;br&gt;<br>&lt;/p&gt;<br><br>&lt;p&gt;<br>&lt;strong&gt;関数とは&lt;/strong&gt;&lt;br&gt;<br>特定の演算をする機能を&lt;strong&gt;関数&lt;/strong&gt;といい、カッコ内に入れる値のことを&lt;strong&gt;引数&lt;/strong&gt;（ひきすう）といいます。また、関数によって得られた値のことを&lt;strong&gt;戻り値&lt;/strong&gt;（もどりち）といいます。<br>&lt;/p&gt;<br>",
