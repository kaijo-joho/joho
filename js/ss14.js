const slidesData = [
  ...
  },
  {
    ...
    "note": "<span class=\"circLine\"><span class=\"circHead\"><strong>①</strong></span><span class=\"circBody\">オートフィルの結果【D8:D29】は <code><span style=\"color:rgb(227, 59, 53);\">#DIV/0!</span></code>となる。</span></span><br>※ <code><span style=\"color:rgb(227, 59, 53);\">#DIV/0!</span></code> はゼロ除算エラー（ 0 または 値なし（空白のセル）で除算した場合のエラー）<br><span class=\"circLine\"><span class=\"circHead\"><strong>②</strong></span><span class=\"circBody\">【D8】を選択すると <code>=C8/C31</code> が入力されている。</span></span><br><span class=\"circLine\"><span class=\"circHead\"><strong>③</strong></span><span class=\"circBody\">これは、オートフィルをすると、<strong>オートフィルの方向にセルの参照先も自動的に移動する</strong>からである。</span></span><br>",
  ...
  {
    "title": "2.1. 順位を求める",
    "note": "<span class=\"circLine\"><span class=\"circHead\"><strong>①</strong></span><span class=\"circBody\">【D7】に <code>=RANK(C7, C7:C29)</code> と入力し、確定する。</span></span><br><span class=\"circLine\"><span class=\"circHead\"><strong>②</strong></span><span class=\"circBody\">【D7】から【D29】までオートフィルする。</span></span><br><br>RANK関数の第3引数は、0またはFALSE（省略時）で降順、1またはTRUEで昇順を指定します。<br>",
    "image": "img_slide/ss14_09.png"
  },
  {
    "title": "2.2. 関数の絶対参照",
    "note": "<span class=\"circLine\"><span class=\"circHead\"><strong>①</strong></span><span class=\"circBody\">絶対参照せずにオートフィルしたので、参照先のセルがひとつずつ下にずれている。</span></span><br><span class=\"circLine\"><span class=\"circHead\"><strong>②</strong></span><span class=\"circBody\">行方向に移動させたくないので、行番号の前に <code>\\$</code> をつけて、オートフィルする。</span></span><br><span class=\"circLine\"><span class=\"circHead\"><strong>③</strong></span><span class=\"circBody\">値は１つ下にずれているが、セル範囲は固定されている。</span></span><br><br>",
